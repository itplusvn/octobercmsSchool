...
return [
    'cms_object' => [
        'invalid_file' => 'Невалидно име на файл: :name. Имената на файловете могат да съдържат само букви и символи, долни черти, тирета и точки. Някои примери за правилни имена на файлове: about-us.htm, страница, поддиректория / страница',
