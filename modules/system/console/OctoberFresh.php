 ...
 *
 * This removes the kenshin theme and plugin. A great way to start a fresh project!
 *
...
class OctoberFresh extends Command
{
     ...
     */
    protected $description = 'Removes the kenshin theme and plugin.';
    ...
    public function fire()
    {
        ...
        $demoThemePath = themes_path().'/kenshin';
